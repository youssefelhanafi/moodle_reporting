...
$string['pluginname'] = 'AC2I Reporting Block';
$string['reporting'] = 'Reporting';
$string['reporting:addinstance'] = 'Add a new reporting block';
$string['reporting:myaddinstance'] = 'Add a new reporting block to the My Moodle page';
$string['contentinputlabel'] = 'Block Content';
$string['titleinputlabel'] = 'Block Title';
$string['defaulttitle'] = 'Default Block Title';
$string['headerconfig'] = 'Hello world Global Config';
